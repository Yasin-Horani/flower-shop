...
<table id="cart" class="table table-hover table-condensed">
    ...
    <tfoot>
    <tr>
        <td colspan="5" class="text-right"><h3><strong>Totaal €{{ $total }}</strong></h3></td>
    </tr>
    <tr>
        <td colspan="5" class="text-right">
            <a href="{{ url('/') }}" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Shopping</a>
            <a href="{{ url('https://www.ideal.nl/demo/') }}" class="btn btn-success"><i class="fa fa-angle-left"></i>Betalen</a>
        </td>
    </tr>
    </tfoot>
</table>
